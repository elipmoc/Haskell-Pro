...
/* package mvarTest-0.1.0.0 */
#define VERSION_mvarTest "0.1.0.0"
#define MIN_VERSION_mvarTest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "mvarTest-0.1.0.0-E0QW1JYndlrCpEsWSbVqLX"

#define CURRENT_PACKAGE_KEY "mvarTest-0.1.0.0-E0QW1JYndlrCpEsWSbVqLX"
