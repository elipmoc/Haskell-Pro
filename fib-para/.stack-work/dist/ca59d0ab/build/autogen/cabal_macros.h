...
/* package fib-para-0.1.0.0 */
#define VERSION_fib_para "0.1.0.0"
#define MIN_VERSION_fib_para(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fib-para-0.1.0.0"

#define CURRENT_PACKAGE_KEY "fib-para-0.1.0.0"
